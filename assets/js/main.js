...
function dateDifference(startDate, endDate) {
  ...
  if (dayDiff < 0) {
    monthDiff--; // Adjust months if the end day is earlier than the start day
    dayDiff += new Date(end.getFullYear(), end.getMonth(), 0).getDate();
  }

  if (monthDiff < 0) {
    yearDiff--; // Adjust years if the end month is earlier than the start month
    monthDiff += 12;
  }
...
document.getElementById('year_working').innerHTML=difference.years

document.getElementById('month_working').innerText = difference.months

document.getElementById('day_working').innerText = difference.days
